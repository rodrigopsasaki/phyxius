...
describe("file parser", () => {
  ...
  describe("JSON files", () => {
    ...
    it("should reject JSON arrays", () => {
      ...
      if (result._tag === "Err") {
        expect(result.error.type).toBe("PARSE_ERROR");
        expect(result.error.message).toBe("JSON root must be an object");
      }
    });
  ...
  describe("YAML files (no longer supported)", () => {
    it("should return PARSE_ERROR for .yml extension", () => {
    ...
    it("should return PARSE_ERROR for .yaml extension", () => {
...
`;
  ...
  describe("format detection", () => {
    ...
    it("should surface PARSE_ERROR for .yml extension (YAML not supported)", () => {
    ...
    it("should surface PARSE_ERROR for .yaml extension (YAML not supported)", () => {
